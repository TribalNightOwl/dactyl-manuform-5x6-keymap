...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_5x6(
        ...
        _______, KC_Z    , KC_X       , KC_C                        , KC_V         , KC_B  ,                         KC_N  , KC_M        , TD(CT_COMM_SCLN)            , TD(CT_DOT_CLN)              , TD(CT_SLSH_PIPE_BSLSH)    , _______,
                           KC_ESC     , TD(CT_LPRN_LBRC_LCBR_LTHAN) ,                                                                      TD(CT_RPRN_RBRC_RCBR_GTHAN) , TD(CT_SQTE_DQTE_BQTE_CARET) ,
                                                      MOVE    , KC_BSPC ,                                           KC_SPC  , OSM(MOD_RSFT) ,
    ...
    [_RAISE] = LAYOUT_5x6(
          ...
          _______ , _______ , _______ , _______ , KC_NO   , KC_NO      ,                             _______  , KC_BTN1 , KC_BTN3 , KC_BTN2 , _______ , _______ ,
                              _______ , _______ ,                                                               _______ , _______,
                                                  _______,_______,                                   _______,_______,
                                                  _______,_______,                                   _______,_______,
                                                  _______,_______,                                   _______,_______
